...
- 중요도 점수는 1~5 중 하나이며, 숫자가 클수록 더 중요한 문장입니다.
- 이 입력에는 이미 중요도 3, 4, 5인 문장만 포함되어 있습니다.
...
- importance_score가 높을수록 요약에서 더 큰 비중을 두어 반영합니다.
  ...
  - 중요도 4: 가능하면 모두 요약에 반영하되, 핵심 내용 위주로 압축합니다.
  - 중요도 3: 여유가 있을 때 보완 설명 수준으로 포함하되, 요약을 길게 만들지 않도록 선별합니다.
